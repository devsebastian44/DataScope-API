...
from app.core.exceptions import VisualizationError, DataValidationError
...
class VisualizationService:
    ...
    @staticmethod
    def generate_plot(dataset_id: str, plot_type: PlotType, x_column: str = None,
                     y_column: str = None, hue_column: str = None, columns: list = None,
                     title: str = None, xlabel: str = None, ylabel: str = None,
                     color: str = "steelblue", figsize: tuple = (10, 6),
                     plot_format: str = "png", dpi: int = 100) -> dict:
        ...
        try:
            ...
            if plot_type == PlotType.HISTOGRAM:
                ...
                VisualizationService._create_boxplot(df, x_column, y_column, hue_column)
            
            elif plot_type == PlotType.SCATTER:
                VisualizationService._create_scatter(df, x_column, y_column, hue_column, color)
            
            elif plot_type == PlotType.LINE:
                VisualizationService._create_line(df, x_column, y_column, hue_column)
                ...
                VisualizationService._create_violin(df, x_column, y_column, hue_column)
            
            elif plot_type == PlotType.PAIRPLOT:
                VisualizationService._create_pairplot(df, columns, hue_column)
            
            elif plot_type == PlotType.COUNTPLOT:
                VisualizationService._create_countplot(df, x_column, hue_column)
            ...
            # Guardar gráfico
            plt.savefig(plot_path, format=plot_format, dpi=dpi, bbox_inches='tight')
            plt.close()
    ...
    def _create_histogram(df: pd.DataFrame, x_column: str, color: str):
        """Crea histograma"""
        plt.hist(df[x_column].dropna(), bins=30, color=color, edgecolor='black', alpha=0.7)
        plt.ylabel('Frecuencia')
    
    @staticmethod
    def _create_boxplot(df: pd.DataFrame, x_column: str, y_column: str = None, hue_column: str = None):
        """Crea boxplot"""
        if y_column:
    ...
    @staticmethod
    def _create_scatter(df: pd.DataFrame, x_column: str, y_column: str, hue_column: str = None, color: str = "steelblue"):
        """Crea scatter plot"""
        if hue_column:
    ...
    @staticmethod
    def _create_line(df: pd.DataFrame, x_column: str, y_column: str, hue_column: str = None):
        """Crea line plot"""
        if hue_column:
    ...
    @staticmethod
    def _create_bar(df: pd.DataFrame, x_column: str, y_column: str = None, color: str = "steelblue"):
        """Crea bar plot"""
        if y_column:
    ...
    @staticmethod
    def _create_violin(df: pd.DataFrame, x_column: str, y_column: str = None, hue_column: str = None):
        """Crea violin plot"""
        if y_column:
    ...
    @staticmethod
    def _create_pairplot(df: pd.DataFrame, columns: list = None, hue_column: str = None):
        """Crea pairplot"""
        if columns:
    ...
    @staticmethod
    def _create_countplot(df: pd.DataFrame, x_column: str, hue_column: str = None):
        """Crea countplot"""
