...
class DataProcessor:
    ...
    @classmethod
    def store_dataset(cls, dataset_id: str, df: pd.DataFrame, filename: str, file_size: int) -> dict:
    ...
    @classmethod
    def clean_data(cls, dataset_id: str, drop_duplicates: bool = False,
                   fill_na_strategy: Optional[str] = None,
                   columns_to_drop: Optional[List[str]] = None,
                   type_conversions: Optional[Dict[str, str]] = None) -> dict:
        """Limpia el dataset"""
            ...
            for col, dtype in type_conversions.items():
                if col in df.columns:
                    try:
                        ...
                        raise DataValidationError(f"No se pudo convertir '{col}' a {dtype}: {str(e)}")
